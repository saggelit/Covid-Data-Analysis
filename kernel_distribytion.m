...
United_Kingdom=148;
[UK_C,UK_D]=Fun1(Covid_Confirmed,Covid_Deaths,United_Kingdom,73,211);
figure(1)
bar(UK_C)
...
[h_UK_C,p_UK_C,h_UK_D,p_UK_D]=Fun2('United Kingdom',UK_C,UK_D);

France=49; % Country code
[FR_C,FR_D]=Fun1(Covid_Confirmed,Covid_Deaths,France,57,149);
figure(11)
bar(FR_C)
xlabel('Numberd Days of 1st Wave')
ylabel('Daily Covid Confirmed Counts')
...
[h_FR_C,p_FR_C,h_FR_D,p_FR_D]=Fun2('France',FR_C,FR_D);

Germany=53; % Country code
[DEU_C,DEU_D]=Fun1(Covid_Confirmed,Covid_Deaths,Germany,57,167);
figure(12)
bar(DEU_C)
...
[h_DEU_C,p_DEU_C,h_DEU_D,p_DEU_D]=Fun2('Germany',DEU_C,DEU_D);

Greece=55;
[GR_C,GR_D]=Fun1(Covid_Confirmed,Covid_Deaths,Greece,58,154);
figure(13)
bar(GR_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_GR_C,p_GR_C,h_GR_D,p_GR_D]=Fun2('Greece',GR_C,GR_D);

Italy=68;
[IT_C,IT_D]=Fun1(Covid_Confirmed,Covid_Deaths,Italy,53,197);
figure(14)
bar(IT_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_IT_C,p_IT_C,h_IT_D,p_IT_D]=Fun2('Italy',IT_C,IT_D);

Netherlands=98;
[NL_C,NL_D]=Fun1(Covid_Confirmed,Covid_Deaths,Netherlands,59,193);
figure(15)
bar(NL_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_NL_C,p_NL_C,h_NL_D,p_NL_D]=Fun2('Netherlands',NL_C,NL_D);

Poland=113;
[PL_C,PL_D]=Fun1(Covid_Confirmed,Covid_Deaths,Poland,68,192);
figure(16)
bar(PL_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_PL_C,p_PL_C,h_PL_D,p_PL_D]=Fun2('Poland',PL_C,PL_D);

Russia=118;
[RU_C,RU_D]=Fun1(Covid_Confirmed,Covid_Deaths,Russia,72,241);
figure(17)
bar(RU_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_RU_C,p_RU_C,h_RU_D,p_RU_D]=Fun2('Russia',RU_C,RU_D);

Spain=131;
[ES_C,ES_D]=Fun1(Covid_Confirmed,Covid_Deaths,Spain,56,160);
figure(18)
bar(ES_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_ES_C,p_ES_C,h_ES_D,p_ES_D]=Fun2('Spain',ES_C,ES_D);

Sweden=134;
[SE_C,SE_D]=Fun1(Covid_Confirmed,Covid_Deaths,Sweden,58,202);
figure(19)
bar(SE_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_SE_C,p_SE_C,h_SE_D,p_SE_D]=Fun2('Sweden',SE_C,SE_D);

Turkey=144;
[TR_C,TR_D]=Fun1(Covid_Confirmed,Covid_Deaths,Turkey,74,155);
figure(110)
bar(TR_C)
xlabel('Numberd Days of 1st Wave');ylabel('Daily Covid Confirmed Counts')
...
[h_TR_C,p_TR_C,h_TR_D,p_TR_D]=Fun2('Turkey',TR_C,TR_D);
